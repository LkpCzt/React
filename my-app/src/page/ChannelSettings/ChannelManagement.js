...
const columns = [
    ...
    {
        title: '资源剩余',
        dataIndex: 'resourceSurplus',
        sorter: (a, b) => b.resourceSurplus.localeCompare(a.resourceSurplus)
    },
    {
        title: '状态',
        dataIndex: 'state',
    ...
    {
        title: '关联屏蔽词',
        dataIndex: 'associativeShieldingWords',
        sorter: (a, b) => b.associativeShieldingWords.localeCompare(a.associativeShieldingWords)
    },
    {
        title: '创建时间',
...
const data = [
    {
        "channelName":"通道名称",
        "resourceSurplus":"资源剩余",
        "state":"状态",
        "type":"类型",
        "associativeShieldingWords":" 关联屏蔽词",
        "createDate":"创建时间",
        "key":"1"
    }
];
...
class ChannelManagement extends Component {
    search(){
        ...
        searchCondition.channel=document.getElementById('channel').value;
